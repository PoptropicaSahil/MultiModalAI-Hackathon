...
##button to choose(new addition):
def load_pdf_data():
    pass


# Function to handle user input
# def handle_user_input(user_input, data_loader):
#     if data_loader == "GitHub":
#         return load_github_data(user_input)
#     elif data_loader == "PDF":
#         return load_pdf_data()

# Get user input for GitHub URL or PDF
data_loader = st.radio("Select data source", ("GitHub", "PDF"))
...
if st.button("Submit"):
    if data_loader == "GitHub":
        # index = handle_user_input(github_url, data_loader)
        index = load_data()
    # elif data_loader == "PDF":
    #     index = handle_user_input(pdf_path, data_loader)
